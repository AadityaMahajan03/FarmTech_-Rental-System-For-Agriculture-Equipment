...
class Customers
{
	...
	public function getCustomersOrder(){
		$query = $this->con->query("SELECT  o.cust_name, o.order_id,  o.product_id,  o.qty, o.trx_id, o.p_status, o.cust_num, p.product_title, p.product_image FROM orders o JOIN products p ON o.product_id = p.product_id");
