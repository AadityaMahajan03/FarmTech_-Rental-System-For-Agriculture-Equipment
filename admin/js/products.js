$(document).ready(function() {
    ...
    $(".add-product").on("click", function(e) {
        ...
        if (!$("input[name='product_name']").val() || !$("select[name='brand_id']").val() || 
            !$("select[name='category_id']").val() || !$("input[name='product_qty']").val() || 
    ...
    $(document.body).on("click", ".edit-product", function() {
        try {
            ...
            $("input[name='e_product_video']").val(product.product_video);
    ...
    $(".submit-edit-product").on('click', function() {
        // Validate required fields
        if (!$("input[name='e_product_name']").val() || !$("select[name='e_brand_id']").val() || 
            !$("select[name='e_category_id']").val() || !$("input[name='e_product_qty']").val() || 
            !$("input[name='e_product_price']").val()) {
            alert("Please fill all required fields!");
            return;
        }
